...
A collection of technical blog posts covering Azure, Python, and cloud development topics.
...
| 2026-02-02 | [Python Virtual Environments: venv vs uv](python-venv-vs-uv.md) | Python, venv, uv, Package Management |
...
### Python
- [Python Virtual Environments: venv vs uv](python-venv-vs-uv.md)
